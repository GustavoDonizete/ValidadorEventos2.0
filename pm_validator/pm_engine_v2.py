...
def score_pillar6(df: pd.DataFrame, case_col: str, act_col: str,
    ...
    return {
        ...
        "subcategories": {
            ...
            "6.3_sobreposicao":           {"score": s63 if s63 is not None else "N/A",      "max": 20},
...
def _build_log_rows(result: dict, id_execucao: int) -> tuple:
    ...
    row_exec = {
        ...
        "tempo_minutos":     result["tempo_minutos"],
        # Tamanho
...
def export_to_excel(result: dict, excel_path: str = "pm_engine_log.xlsx") -> str:
    ...
    # ── ABA execucoes ──
    EXEC_HEADERS = [
        "id_execucao", "nome_base", "data_execucao", "ts_inicio", "ts_fim",
        "tempo_minutos",
        "n_linhas", "n_cases", "n_atividades", "periodo_dias",
        "score_p1", "score_p2", "veredicto", "n_gates_disparados",
        "score_p3", "score_p4", "score_p5", "score_p6",
    ...
    # Colorir células de classificação e veredicto
...
def start_server(port: int = 5000):
    ...
    def analyze():
        try:
            ...
            end_col   = mapping.get("timestamp_fim") or None
