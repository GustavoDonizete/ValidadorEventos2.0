...
|-------|--------------|---------------|
| ≥ 95  | APTA | Base pronta para mineração |
| ≥ 80  | APTA_COM_RESSALVAS | Utilizável, mas com pontos de atenção |
| < 80  | NAO_APTA | Necessita correção antes de minerar |
...
O threshold da mediana é calculado dinamicamente: `mediana(eventos/case) × max(eventos/case)`.
Bases com granularidade alta (muitos eventos por case) terão thresholds maiores, tornando o critério adaptativo à escala real do processo.

| Condição | Pontos |
|----------|--------|
| Mediana ≥ threshold (mediana × max) | 15 |
| Mediana ≥ 66% do threshold | 12 |
| Mediana ≥ 50% do threshold | 8 |
| Mediana ≥ 2 eventos | 4 |
| Mediana < 2 | 0 + **GATE** |
...
| Cases com 1 evento > 95% | P2 | pct_lt2 > 95% | P2 INAPTO, sub2.2 = 0 |
